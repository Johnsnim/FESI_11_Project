...
export default function Info({ user }: { user: User }) {
  return (
    <div>
      ...
      <div className="flex h-25 w-full items-center rounded-2xl border border-green-300 bg-gradient-to-r from-[#E5FCF0] to-[#D9F6F4] px-4 py-6 md:h-31 md:px-6 lg:h-fit lg:flex-col lg:pt-5 lg:pb-10">
        ...
        <div className="ml-4 flex gap-2 border-l-[1.5px] pl-4 text-sm font-medium text-[#a4a4a4] md:ml-7 md:pl-7.5 md:text-base lg:ml-0 lg:border-t-[1.5px] lg:border-l-0 lg:px-2 lg:pl-0 lg:pt-7.5 lg:mt-7">
